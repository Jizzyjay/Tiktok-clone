...
export default function Upload() {
  ...
  const validate = () => {
    ...
    if (!file) {
      setError({ type: "File", message: "Video is required" });
      isError = true;
    } else if (!caption) {
      setError({ type: "caption", message: "Caption is required" });
      isError = true;
    }
    return isError;
  };
          ...
          <div className="mt-8 md:flex gap-6">
            {!fileDisplay ? (
              <label
                htmlFor="fileInput"
                className="
                md:mx-0 mx-auto mt-4 mb-6 flex flex-col items-center 
                justify-center w-full max-w-[260px] h-[470px] 
              ...
              <div
                className="
                md:mx-0 mx-auto mt-4 md:mb-12 mb-16 flex items-center 
                justify-center w-full max-w-[260px] h-[540px] p-3 
            ...
            <div className="mt-4 mb-6">
              ...
              <div className="mt-5">
                ...
                <input
                  ...
                  type="text"
                  className="
                  w-full border p-2.5 rounded-md focus:outline-none
                  "
                  value={caption}
